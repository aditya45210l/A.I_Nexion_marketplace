...
import { decryptAPIKey } from "@/lib/actions/EncryptDecript";
...
const ChatBotDemo = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 relative size-full h-[calc(100vh-3rem)]">
      <div className="flex flex-col h-full border">
        ...
        <PromptInput
          onSubmit={handleSubmitWithChecks}
          className="mt-4"
          globalDrop
          multiple
        >
